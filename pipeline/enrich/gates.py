...
def e6_rebuilt_golden_loses_nothing(before: dict[str, int], after: dict[str, int],
    ...
    """
    # allowed_loss names the legitimate shrinkage: what E10 and E11 withheld, plus any allowance an
    # operator declared for this one run (promote.parse_allowed_loss), field by field.
