"""adl_july — one of ADL's own plant lists. See pipeline/sources/_adl_list.py for the shared reader,
...
def pull(source: dict, cfg: dict, archive_dir: Path) -> list[dict]:
    raise NotImplementedError("adl_july is blob-only: upload the transcribed list, then re-run")
