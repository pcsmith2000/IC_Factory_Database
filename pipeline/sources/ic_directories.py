"""ic_directories — see pipeline/sources/_evidence_csv.py for the shared schema, the README this
...
def pull(source: dict, cfg: dict, archive_dir: Path) -> list[dict]:
    raise NotImplementedError("ic_directories is blob-only: upload the evidence CSV, then re-run")
