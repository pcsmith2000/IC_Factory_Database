...
if __name__=='__main__':
    p=argparse.ArgumentParser();p.add_argument('--mode',choices=['plan','cached','historical_cached','fl_bcis','md_labor','md_labor_crossmatch','internal_crossmatch_plan','internal_crossmatch','overture_pilot','overture_rooftop','geocode'],default='plan');p.add_argument('--pass-id',default='1');p.add_argument('--limit',type=int,default=100);a=p.parse_args()
